...
!(function (c) {
  ...
  var n,
    ...
    a,
    s,
    l = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    v = function (n) {
      ...
      return p(t) && t ? 1 : !m(t) || ("http" !== t && "https" !== t) ? 0 : t;
    },
    y = function (n) {
    ...
    N = function (n) {
      if (!P.ie || 10 < P.ie) {
        ...
        e.initMouseEvent(
          ...
          i.dispatchEvent(u),
          c.document.body.removeChild(i);
      } else {
        var r = c.window.open("", "_blank");
        if (r) {
          r.opener = null;
          var o = r.document;
          o.open(),
    ...
    M = {
      ...
      none: R,
      from: function (n) {
        return null === n || n === undefined ? D : U(n);
      },
    },
      ...
      var e,
        ...
        u = function (n) {
          return n.filter(function (n) {
            return -1 === $.inArray(o, n);
          });
        },
        c = t ? (0 < (e = u((e = i))).length ? e.concat(o) : o) : u(i);
      return 0 < c.length ? ((r = c), $.trim(r.sort().join(" "))) : "";
    },
    X = function (n, t) {
      return (
        (t = t || n.selection.getNode()),
        Y(t) ? n.dom.select("a[href]", t)[0] : n.dom.getParent(t, "a[href]")
      );
    },
    Q = function (n) {
    ...
    en = function (h, p, g) {
      h.undoManager.transact(function () {
        var n,
          ...
          a,
          l,
          f = h.selection.getNode(),
          s = X(h, f),
          d = Z(g);
        if (!(0 < b(h).length) && !1 === O(h)) {
          var m = J(d.rel, "_blank" === d.target);
          d.rel = m || null;
        }
        M.from(d.target).isNone() && (d.target = x(h)),
          (d.href =
            ((n = d.href),
            ("http" !== (t = v(h)) && "https" !== t) || G(n)
              ? n
              : t + "://" + n)),
          g.href === p.href && p.attach(),
          s
            ? (h.focus(),
              (u = h),
              (c = s),
              ...
              (l = d),
              a.each(function (n) {
                c.hasOwnProperty("innerText")
                  ? (c.innerText = n)
                  : (c.textContent = n);
              }),
              u.dom.setAttribs(c, l),
              u.selection.select(c))
            : ((e = h),
              (r = f),
              (o = g.text),
              (i = d),
              Y(r)
                ...
                : o.fold(
                    ...
                    function (n) {
                      e.insertContent(
                        e.dom.createHTML("a", i, e.dom.encode(n))
                      );
                    }
                  ));
      });
    ...
    mn = function (n) {
      return m(n.value) ? n.value : "";
    },
    hn = function (e) {
      return (
        void 0 === e && (e = mn),
        function (n) {
          return M.from(n).map(function (n) {
            return (
              (t = n),
              (r = e),
              (o = []),
              $.each(t, function (n) {
                var t = m(n.text) ? n.text : m(n.title) ? n.title : "";
                if (n.menu !== undefined);
                else {
                  var e = r(n);
    ...
    vn = function (t, n, e, r) {
      ...
      return u !== undefined
        ? ((o = u),
          (i = e),
          dn(i, function (n) {
            return M.some(n).filter(function (n) {
              return n.value === o;
            });
          })).map(function (n) {
            return {
        ...
        onChange: function (n, t) {
          return "url" === t.name
            ...
            : ((e = ["anchor", "link"]),
              ...
              -1 < q(e, r)
                ? o(n(), t)
                : ("text" === t.name && u.set(n().text), M.none()));
          var e, r;
        },
      };
    },
  ...
  (i = undefined),
    ...
    (function (n) {
      ...
      return (function f(i, u, c) {
        function a(t, n) {
          if (!u[t]) {
            if (!i[t]) {
              var e = "function" == typeof s && s;
              if (!n && e) return e(t, !0);
              if (l) return l(t, !0);
        ...
        for (var l = "function" == typeof s && s, n = 0; n < c.length; n++)
          a(c[n]);
        return a;
      })(
        {
              ...
              (i.nextTick = function (n) {
                ...
                if (1 < arguments.length)
                  for (var e = 1; e < arguments.length; e++)
                    t[e - 1] = arguments[e];
                f.push(new p(n, t)), 1 !== f.length || s || a(h);
              }),
  ...
  var bn = kn.exports.boltExport,
    ...
    Nn = tinymce.util.Tools.resolve("tinymce.util.Delay"),
    En = function (n) {
      var t = n.href;
      return 0 < t.indexOf("@") &&
        -1 === t.indexOf("//") &&
      ...
      return dn(
        [
          ...
          function (n) {
            var t = n.href;
            return (1 === e && !sn(t)) ||
              (0 === e && /^\s*www[\.|\d\.]/i.test(t))
              ? M.some({
                  message:
                    "The URL you entered seems to be an external link. Do you want to add the required http:// prefix?",
                  preprocess: function (n) {
                    return wn({}, n, { href: "http://" + t });
                  },
                })
              : M.none();
          }),
        ...
        function (i) {
          return Cn(function (t) {
            ...
            (e = u),
              (n = i.message),
              (r = function (n) {
                t(n ? i.preprocess(c) : c);
              }),
              (o = e.selection.getRng()),
              Nn.setEditorTimeout(e, function () {
                e.windowManager.confirm(n, function (n) {
                  e.selection.setRng(o), r(n);
                });
              });
          });
        }
    ...
    jn = function (n) {
      ...
      return 0 < e.length
        ? M.some([{ text: "None", value: "" }].concat(e))
        : M.none();
    },
    Sn = function (n) {
      var t = _(n);
      return 0 < t.length ? pn.sanitize(t) : M.none();
    },
    ...
    Ln = function (t) {
      ...
      return Cn(function (t) {
        ...
        return n.bind(pn.sanitizeWith(e)).map(function (n) {
          return 0 < n.length ? [{ text: "None", value: "" }].concat(n) : n;
        });
      });
    },
    Rn = function (n, t) {
      ...
      if (0 < e.length) {
        ...
        return (
          !1 === O(n)
            ? pn.sanitizeWith(function (n) {
                return fn(pn.getValue(n), r);
              })
            : pn.sanitize
        )(e);
      }
    ...
    Un = function (n) {
      var t = k(n);
      return h(t)
        ? pn.sanitize(t).orThunk(function () {
            return M.some(Dn);
          })
        : !1 === t
        ? M.none()
    ...
    Mn = function (n, t, e) {
      ...
      return null !== r && 0 < r.length ? M.some(r) : M.none();
    },
    zn = function (f, s) {
      return Ln(f).map(function (n) {
        var t,
          e,
          r,
          o,
          ...
          l =
            ((e = s),
            (r = (t = f).dom),
            (o = cn(t.selection.getContent())
              ? M.some(ln(t.selection, e))
              : M.none()),
            (i = e ? M.some(r.getAttrib(e, "href")) : M.none()),
            (u = e ? M.from(r.getAttrib(e, "target")) : M.none()),
            (c = Mn(r, e, "rel")),
            (a = Mn(r, e, "class")),
            {
              url: i,
        ...
        .map(function (n) {
          var i,
            ...
            p =
              ...
              function (n) {
                var e = n.getData();
                if (!e.url.value) return rn(i), void n.close();
                var t = function (t) {
                    return M.from(e[t]).filter(function (n) {
          ...
          return (
            ...
            (h = t.catalogs),
            {
              ...
              body: {
                ...
                items: W([
                  ...
                  (function (n) {
                    ...
                    h.anchor.map(pn.createUi("anchor", "Anchors")),
                    h.rels.map(pn.createUi("rel", "Rel")),
                    h.targets.map(pn.createUi("target", "Open link in...")),
                    h.link.map(pn.createUi("link", "Link list")),
                    h.classes.map(pn.createUi("linkClass", "Class")),
                  ]),
                ]),
              },
              buttons: [
              ...
              onChange: function (t, n) {
                var e = n.name;
                m.onChange(t.getData, { name: e }).each(function (n) {
                  t.setData(n);
                });
              },
              onSubmit: e,
    ...
    $n = function (r) {
      r.on("click", function (n) {
        var t = Kn(r, n.target);
        t && f.metaKeyPressed(n) && (n.preventDefault(), Vn(r, t));
      }),
        r.on("keydown", function (n) {
          ...
          e &&
            ...
            !1 === t.ctrlKey &&
            !1 === t.metaKey &&
            (n.preventDefault(), Vn(r, e));
        });
    },
    Gn = function (e) {
      return function (t) {
        var n = function (n) {
          return t.setActive(!e.readonly && !!an(e, n.element));
        };
        return (
          e.on("NodeChange", n),
          function () {
    ...
    Jn = function (e) {
      return function (t) {
        t.setDisabled(!on(e.dom.getParents(e.selection.getStart())));
        var n = function (n) {
          return t.setDisabled(!on(n.parents));
        };
        return (
          e.on("NodeChange", n),
          function () {
    ...
    nt = function (t) {
      t.ui.registry.addContextMenu("link", {
        update: function (n) {
          return on(t.dom.getParents(n, "a")) ? "link unlink openlink" : "link";
        },
      });
    },
    tt = function (i) {
      var n = function (n) {
        ...
        return n.setDisabled(!an(i, t)), function () {};
      };
        ...
        commands: [
          {
            ...
            onSetup: function (n) {
              var t = i.selection.getNode();
              return n.setActive(!!an(i, t)), Gn(i)(n);
            },
            onAction: function (n) {
              var t = an(i),
                e = n.getValue();
              if (t)
                ...
                var r = { href: e, attach: function () {} },
                  o = cn(i.selection.getContent())
                    ? M.some(ln(i.selection, t))
                        .filter(function (n) {
                          return 0 < n.length;
                        })
                        .or(M.from(e))
  ...
  !(function et() {
    l.add("link", function (n) {
      Yn(n), Zn(n), nt(n), tt(n), $n(n), Xn(n), Qn(n);
    });
  })();
})(window);
