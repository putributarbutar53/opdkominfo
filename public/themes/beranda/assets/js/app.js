  ...
  APP.slickSlider = {
    ...
    slickSetup: function () {
      var options_default = {
        ...
        vertical: false,
        prevArrow:
          '<div class="slick-prev" aria-label="Previous"><i class="fas fa-chevron-left"></i></div>',
        nextArrow:
          '<div class="slick-next" aria-label="Next"><i class="fas fa-chevron-right"></i></div>',
  ...
  APP.tinymce = {
    init: function () {
      ...
      tinymce.init({
        ...
        toolbar:
          " styleselect | bold italic underline | bullist numlist blockquote | link unlink",
        menubar: false,
        branding: false,
      });
    },
